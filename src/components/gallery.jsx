    ...
    return (
        <>
                    <img className="[ gallery-img ]" src={img} alt="Some tag" />
                        ...
                        <br />
                        <ul>
                            <li>{linkDescription1} <a href={links1} alt="link" target="_blank" style={{display: "table-cell"}}>{links1}</a></li>
                            <li>{linkDescription2} <a href={links2} alt="link" target="_blank" style={{display: "table-cell"}}>{links2}</a></li>
                        </ul>
